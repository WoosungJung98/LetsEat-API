...
=======
COMMENT ON COLUMN {schema_name}.friends.user_id IS '22 character string user id';
COMMENT ON COLUMN {schema_name}.friends.friend_id IS '22 character string of user who is friends with the user id';
>>>>>>> cb81b27 (photos api)
